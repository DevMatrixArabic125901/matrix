...
class Config(object):
    ...
    # كود تيرمكس باستخدام امر python3 stringsetup.py او من موقع https://replit.com/@MATRIXAR/stringsession
    ...
    # رابط الريبو
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/qithoniq/matrix")
    # ملفات خارجيه اضافيه
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/qithoniq/MAPlugins"
    else:
        EXTERNAL_REPO = None
    # فارات الميوزك
    ...
    TIME_MA = os.environ.get("TIME_MA", None)
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://graph.org/file/e1d60e941c41fca9819a6.jpg"
    )
