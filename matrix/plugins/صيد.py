...
@matrix.ar_cmd(pattern="الصيد")
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس دراكو : 
⊱━━━━━⊰✾⊱━━━━━⊰
...
• لمعرفة عدد المحاولات للصيد
⊱━━━━━⊰✾⊱━━━━━⊰
@Matrix_Thon  - channle userbot 

"""
    )


@matrix.ar_cmd(pattern="صيد (.*)")
        ...
        try:
            ch = await matrix(
                functions.channels.CreateChannelRequest(
                    ...
                    about="This channel to hunt username by - @Matrix_Thon ",
                )
            )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/Matrixvois/2",
                    caption="Matrix the best\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ⟨ @{} ⟩\n- ClickS: ⟨ {} ⟩\n- Type: {}\n- Save: ⟨ Chaneel ⟩\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ⟨ @Matrix_Thon - @FFlXlX ⟩ ".format(
...
async def _(event):
    ...
    isclaim.clear()
    isclaim.append("off")
    await matrix.send_message(event.chat_id, "**- تم الانتهاء من التثبيت بنجاح**")


@matrix.ar_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@matrix.ar_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
