...
@matrix.ar_cmd(pattern="الامر3")
async def hi(event):
    await edit_or_reply(
        event,
        "قائمـه اوامر الترحيب :\n\n ✾  `.ترحيب`\n❃ اكتب الامر مع الترحيب ليقوموا بالترحيب في المستخدمين الجدد في المجموعة\n\n ✾  `.الترحيب`\n❃ لعرض رساله الترحيب الحاليه اكتب الامر فقط\n\n ✾  `.حذف الترحيب`\n❃ لالغاء الترحيب في المستخدمين فقط اكتب الامر\n\n⌔∮ متغيرات الترحيب [اضغط هنا](https://t.me/Matrix_Thon)",
        link_preview=False,
    )


@matrix.ar_cmd(pattern="الامر4")
async def hi(event):
    await edit_or_reply(
        event,
        "قائمـه اوامر الردود :\n\n ✾  `.رد`\n❃ يستخدم الأمر بإضافة رد في المجموعه اكتب الامر والرد الخاص بك بالرد على الكلمه \n\n ✾  `.حذف الردود`\n❃ فقط اكتب الامر في الدردشه لحذف جميع الردود المضافه\n\n ✾  `.الردود`\n❃ لعرض الردود المصافه فقط اكتب الامر\n\n ✾  `.ايقاف`\n❃ اكتب الامر مع الرد لحذف الرد من الدردشه\n\n⌔∮ شرح توضيحي عن اوامر الردود  [اضغط هنا](/t.me/Matrix_Thon - أوامر أكثون)\n⌔∮ شرح عن متغيرات الردود  [اضغط هنا](https://t.me/Matrix_Thon)",
        link_preview=False,
    )


@matrix.ar_cmd(pattern="م5")
async def hi(event):
    await edit_or_reply(
        event,
