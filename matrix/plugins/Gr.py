...
async def _(event):
    ...
    matrixevent = await edit_or_reply(event, "**᥀︙ جاري تفليش مجموعتك أنتظر قليلآ 🚮**")
    ...
    await matrixevent.edit(f"**᥀︙  تم بنجاح تفليش مجموعتك من {total} الاعضاء 🚮**")
...
@matrix.ma_cmd(pattern="اكتم(?:\s|$)([\s\S]*)",)
...
@matrix.ma_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
