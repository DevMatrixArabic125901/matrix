...
@matrix.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular matrix",
    },
)
...
@matrix.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}مودي <نص>",
        "examples": "{tr}مودي ماتركس الاصلي",
    },
)
async def nekobot(cat):
...
@matrix.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catmatrix is One of the Popular matrix",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@matrix.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular matrix",
    },
)
async def nekobot(cat):
...
@matrix.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular matrix",
    },
)
async def nekobot(cat):
