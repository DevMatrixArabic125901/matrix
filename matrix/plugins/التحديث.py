...
from matrix import HEROKU_APP, UPSTREAM_REPO_URL, matrix
...
@matrix.ar_cmd(pattern="تحديث(| الان)?$")
async def upstream(event):
    ...
    try:
        txt = "فشل في التحديث لسورس ماتركس " + "**✾ حدث خطأ ما :**\n"
    ...
    if changelog == "" and not force_update:
        await event.edit(
            "\n**✾ سورس ماتركس محدث الى أخر اصدار**"
    ...
    if conf == "الان":
        await event.edit("**✾ جار تحديث سورس ماتركس أنتظر قليلا**")
