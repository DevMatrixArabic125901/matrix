...
from matrix import Config, matrix
...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا وسهلا اخي  {mention} **\
                        \n**⌔︙ {my_mention}'انا البوت المساعد .**\
                        \n**⌔︙ يمكنك التواصل مع صاحب البوت فقط ارسل رسالتك 👤.**\
                        \n\n**⌔︙ البوت خاص بسورس :** [Source MaTriX](t.me/Matrix_ThoN)"
        buttons = [
            (
                Button.url("تنصيب سورس", "t.m$q*!
deathe/Matrix_Thon"),
                Button.url(
                    "للمساعدة",
...
async def send_flood_alert(user_) -> None:
    ...
    if found:
        ...
        try:
            ...
            if BOTLOG:
                await matrix.tgbot.send_message(BOTLOG_CHATID, "**Unblock your bot !**")
