...
from wand.image import Image as matriximage
...
async def matrix_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def matrix_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = matriximage(filename=picture_name)
    main_image.resize(
