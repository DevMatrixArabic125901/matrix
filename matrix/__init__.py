...
from .core.session import matrix, tgbot
...
__author__ = "سورس ماتركس <https://github.com/qithoniq/matrix>"
__copyright__ = f" حقوق سورس ماتركس (C) 2020 - 2022  {__author__}"
