            ...
            async def wrapper(check):
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text += f" عذرا قم بكتابه الأمر بشكل صحيح راجع : @Matrixthon ** "
...
MatrixUserBotClient.fast_download_file = download_file
MatrixUserBotClient.fast_upload_file = upload_file
MatrixUserBotClient.reload = restart_script
MatrixUserBotClient.get_msg_link = get_message_link
MatrixUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    MatrixUserBotClient.send_message = send_message
    MatrixUserBotClient.send_file = send_file
    MatrixUserBotClient.edit_message = edit_message    
