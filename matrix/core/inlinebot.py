...
from iqso import matrix, catversion, StartTime
...
CATLOGO = "https://graph.org/file/21db998a6c0717a982761.mp4"
...
async def inline_handler(event):  
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**matrixbot"):
            buttons = [
                (
                    Button.inline("السورس", data="stats"),
                    Button.url("الريبو", "https://github.com/qithoniq/temp"),
                )
            ]
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/telethontesthelp/Telethon-matrix"),
                Button.url(
                    "Deploy",
        ...
        result = types.InputBotInlineResult(
            ...
            url="https://dashboard.heroku.com/new?template=https://github.com/qithoniq/temp",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
